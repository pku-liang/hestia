module {
  tor.design @kernel_syr2k {
    ...
    %c31_i32_13 = arith.constant {dump = "new_constant_1"} 31 : i32
    ...
    tor.func @main(...) attributes {clock = 6.000000e+00 : f32, dump = "op_67", resource = "../resource.json", strategy = "static"} {
      ...
      on (0 to 22){
        ...
        on (2 to 6){
          %5 = arith.shli %arg0, %c5_i32_9 {dump = "op_13", endtime = 4 : i32, starttime = 3 : i32} : i32
          ...
          %9 = arith.shli %arg0, %c5_i32_8 {dump = "op_18", endtime = 4 : i32, starttime = 3 : i32} : i32
        ...
        on (8 to 20){
          %5 = tor.addi %arg0 %c1_i32_5 on (9 to 10) {dump = "op_28"} : (i32, i32) -> i32
          %6 = tor.subi %5 %c1_i32 on (9 to 10) {dump = "control_3"} : (i32, i32) -> i32
          tor.for %arg2 = (%c0_i32 : i32) to (%6 : i32) step (%c1_i32 : i32)
          on (10 to 18){
            %7 = arith.shli %arg2, %c5_i32_4 {dump = "op_31", endtime = 12 : i32, starttime = 11 : i32} : i32
            ...
            %11 = arith.shli %arg0, %c5_i32_3 {dump = "op_36", endtime = 12 : i32, starttime = 11 : i32} : i32
            ...
            %15 = arith.shli %arg2, %c5_i32_2 {dump = "op_41", endtime = 12 : i32, starttime = 11 : i32} : i32
            ...
            %19 = arith.shli %arg0, %c5_i32_1 {dump = "op_46", endtime = 12 : i32, starttime = 11 : i32} : i32
            ...
            %24 = arith.shli %arg0, %c5_i32_0 {dump = "op_52", endtime = 12 : i32, starttime = 11 : i32} : i32
