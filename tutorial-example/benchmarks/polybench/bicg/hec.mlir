module {
  hec.design @kernel_bicg {
    %true = arith.constant {dump = "const_15"} true
    %c8_i32 = arith.constant {dump = "op_21"} 8 : i32
    %c255_i32 = arith.constant {dump = "new_constant_2"} 255 : i32
    ...
    hec.component @main(%arg0: i1) -> (%arg1: i1)
      ...
      hec.stateset {
        ...
        hec.state @s1 {
          ...
          hec.assign %mem_global_1.w_data = %c0_i32 : i32 -> i32
        ...
        hec.state @s7 {
          ...
          %2 = hec.shift_left %r_main_2.reg %c8_i32 {dump = "comb_7"} : i32
          %3 = hec.addi %r_main_3.reg %2 {dump = "comb_8"} : (i32, i32) -> i32
          hec.assign %mem_global_0.addr = %3 : i32 -> i16
        ...
        hec.state @s8 {
          ...
          hec.assign %r_main_5.reg = %mem_global_4.r_data : i32 -> i32
          hec.assign %r_main_8.reg = %mem_global_2.r_data : i32 -> i32
          hec.assign %mem_global_0.addr = %r_main_7.reg : i32 -> i16
          hec.enable %mem_global_0.r_en : i1
        ...
        hec.state @s10 {
          %0 = hec.addi %r_main_8.reg %muli_main_0.result {dump = "comb_9"} : (i32, i32) -> i32
        ...
        hec.state @s11 {
          ...
          %0 = hec.addi %r_main_4.reg %muli_main_0.result {dump = "comb_10"} : (i32, i32) -> i32
          hec.assign %r_main_5.reg = %0 : i32 -> i32
          hec.assign %mem_global_1.addr = %r_main_3.reg : i32 -> i8
        ...
        hec.state @s12 {
          %0 = hec.addi %r_main_3.reg %c1_i32 {dump = "comb_11"} : (i32, i32) -> i32
        ...
        hec.state @s14 {
          %0 = hec.addi %r_main_2.reg %c1_i32 {dump = "comb_13"} : (i32, i32) -> i32
          hec.assign %r_main_2.reg = %0 : i32 -> i32
          %1 = hec.cmpi "sle" %0 %c255_i32 {dump = "comb_14"} : (i32, i32) -> i1
          hec.assign %r_main_0.reg = %1 : i1 -> i1
          hec.transition {
            hec.goto @s4_entry
          }
  ...
  tor.design @kernel_bicg {
    ...
    tor.func @main(...) attributes {clock = 6.000000e+00 : f32, dump = "op_42", resource = "../resource.json", strategy = "static"} {
      ...
      on (0 to 2){
        tor.store %c0_i32 to %1[%arg0] on (1 to 2) {dump = "op_9"} : (i32, !tor.memref<256xi32, [], "rw">[i32])
      } {dump = "op_11"}
      tor.for %arg0 = (%c0_i32 : i32) to (%c255_i32 : i32) step (%c1_i32 : i32)
      on (4 to 14){
        tor.store %c0_i32 to %2[%arg0] on (5 to 6) {dump = "op_15"} : (i32, !tor.memref<256xi32, [], "rw">[i32])
        ...
        on (6 to 12){
          ...
          %7 = arith.shli %arg0, %c8_i32 {dump = "op_22", endtime = 8 : i32, starttime = 7 : i32} : i32
  ...
  } {dump = "op_43", "flatten-array" = 1 : i32, "move-while" = 1 : i32, staticPass = "Done"}
}
